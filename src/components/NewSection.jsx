...
export const NewSection = () => {
  return (
    <div>
<div className='flex-row lg:flex mt-12 '>
<div className='bg-lime-200  h-[200px] lg:w-[50%] rec bg-black relative space-y-4' >
...
<div className=' backdrop-brightness-50 h-[200px] lg:w-[50%] rec2 bg-lime-200 relative space-y-4'>
